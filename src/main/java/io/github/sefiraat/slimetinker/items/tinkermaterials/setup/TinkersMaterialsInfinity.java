...
public final class TinkersMaterialsInfinity {
    ...
    private static final TinkerMaterial REINFORCED_DRACONIUM = new TinkerMaterial(Ids.REINFORCED_DRACONIUM, Materials.INGOT_CAST_REINFORCED_DRACONIUM.asOne(), "#9532a8")
        .setLiquidTexture(SkullTextures.ALLOY_PURPLE_DEEP)
