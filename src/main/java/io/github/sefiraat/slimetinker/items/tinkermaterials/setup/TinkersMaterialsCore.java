...
public final class TinkersMaterialsCore {
    ...
    private static final TinkerMaterial IRON = new TinkerMaterial(Ids.IRON, SlimefunItems.IRON_DUST.asOne(), "#8c8c8c")
    ...
    private static final TinkerMaterial GOLD = new TinkerMaterial(Ids.GOLD, SlimefunItems.GOLD_DUST.asOne(), "#ffe138")
    ...
    private static final TinkerMaterial COPPER = new TinkerMaterial(Ids.COPPER, SlimefunItems.COPPER_DUST.asOne(), "#c99732")
    ...
    private static final TinkerMaterial LEAD = new TinkerMaterial(Ids.LEAD, SlimefunItems.LEAD_DUST.asOne(), "#9043ba")
    ...
    private static final TinkerMaterial SILVER = new TinkerMaterial(Ids.SILVER, SlimefunItems.SILVER_DUST.asOne(), "#d4d4d4")
        .setLiquidTexture(SkullTextures.ALLOY_SILVER)
    ...
    private static final TinkerMaterial ALUMINUM = new TinkerMaterial(Ids.ALUMINUM, SlimefunItems.ALUMINUM_DUST.asOne(), "#b0b0b0")
        .setLiquidTexture(SkullTextures.ALLOY_SILVER)
    ...
    private static final TinkerMaterial TIN = new TinkerMaterial(Ids.TIN, SlimefunItems.TIN_DUST.asOne(), "#a89b9b")
    ...
    private static final TinkerMaterial ZINC = new TinkerMaterial(Ids.ZINC, SlimefunItems.ZINC_DUST.asOne(), "#9ba8a6")
        .setLiquidTexture(SkullTextures.ALLOY_SILVER)
    ...
    private static final TinkerMaterial MAGNESIUM = new TinkerMaterial(Ids.MAGNESIUM, SlimefunItems.MAGNESIUM_DUST.asOne(), "#e8cef5")
    ...
    private static final TinkerMaterial STEEL = new TinkerMaterial(Ids.STEEL, SlimefunItems.STEEL_INGOT.asOne(), "#d1d1d1")
        .setLiquidTexture(SkullTextures.ALLOY_SILVER)
    ...
    private static final TinkerMaterial DAMASCUS_STEEL = new TinkerMaterial(Ids.DAMASCUS_STEEL, SlimefunItems.DAMASCUS_STEEL_INGOT.asOne(), "#a38c8c")
        .setLiquidTexture(SkullTextures.ALLOY_RED)
    ...
    private static final TinkerMaterial DURALUMIN = new TinkerMaterial(Ids.DURALUMIN, SlimefunItems.DURALUMIN_INGOT.asOne(), "#a3a089")
        .setLiquidTexture(SkullTextures.ALLOY_SILVER)
    ...
    private static final TinkerMaterial BRONZE = new TinkerMaterial(Ids.BRONZE, SlimefunItems.BRONZE_INGOT.asOne(), "#877435")
        .setLiquidTexture(SkullTextures.ALLOY_BROWN)
    ...
    private static final TinkerMaterial ALUMINUM_BRONZE = new TinkerMaterial(Ids.ALUMINUM_BRONZE, SlimefunItems.ALUMINUM_BRONZE_INGOT.asOne(), "#bdaa6d")
    ...
    private static final TinkerMaterial HARDENED_METAL = new TinkerMaterial(Ids.HARDENED_METAL, SlimefunItems.HARDENED_METAL_INGOT.asOne(), "#29251a")
        .setLiquidTexture(SkullTextures.ALLOY_SILVER)
    ...
    private static final TinkerMaterial CORINTHIAN_BRONZE = new TinkerMaterial(Ids.CORINTHIAN_BRONZE, SlimefunItems.CORINTHIAN_BRONZE_INGOT.asOne(), "#8a6500")
        .setLiquidTexture(SkullTextures.ALLOY_BROWN)
    ...
    private static final TinkerMaterial SOLDER = new TinkerMaterial(Ids.SOLDER, SlimefunItems.SOLDER_INGOT.asOne(), "#b7afbd")
        .setLiquidTexture(SkullTextures.ALLOY_SILVER)
    ...
    private static final TinkerMaterial BILLON = new TinkerMaterial(Ids.BILLON, SlimefunItems.BILLON_INGOT.asOne(), "#b0c2be")
        .setLiquidTexture(SkullTextures.ALLOY_SILVER)
    ...
    private static final TinkerMaterial BRASS = new TinkerMaterial(Ids.BRASS, SlimefunItems.BRASS_INGOT.asOne(), "#dbcd4b")
        .setLiquidTexture(SkullTextures.ALLOY_TAN)
    ...
    private static final TinkerMaterial ALUMINUM_BRASS = new TinkerMaterial(Ids.ALUMINUM_BRASS, SlimefunItems.ALUMINUM_BRASS_INGOT.asOne(), "#dbd279")
        .setLiquidTexture(SkullTextures.ALLOY_BROWN)
    ...
    private static final TinkerMaterial NICKEL = new TinkerMaterial(Ids.NICKEL, SlimefunItems.NICKEL_INGOT.asOne(), "#ebebeb")
        .setLiquidTexture(SkullTextures.ALLOY_SILVER)
    ...
    private static final TinkerMaterial COBALT = new TinkerMaterial(Ids.COBALT, SlimefunItems.COBALT_INGOT.asOne(), "#9e9e9e")
    ...
    private static final TinkerMaterial REINFORCED_ALLOY = new TinkerMaterial(Ids.REINFORCED_ALLOY, SlimefunItems.REINFORCED_ALLOY_INGOT.asOne(), "#465899")
        .setLiquidTexture(SkullTextures.ALLOY_PURPLE)
    ...
    private static final TinkerMaterial SILICON = new TinkerMaterial(Ids.SILICON, SlimefunItems.SILICON.asOne(), "#f2f2f2")
        .setLiquidTexture(SkullTextures.ALLOY_SILVER)
    ...
    private static final TinkerMaterial FERROSILICON = new TinkerMaterial(Ids.FERROSILICON, SlimefunItems.FERROSILICON.asOne(), "#f2f2f2")
        .setLiquidTexture(SkullTextures.ALLOY_SILVER)
    ...
    private static final TinkerMaterial REDSTONE_ALLOY = new TinkerMaterial(Ids.REDSTONE_ALLOY, SlimefunItems.REDSTONE_ALLOY.asOne(), "#700d21")
        .setLiquidTexture(SkullTextures.ALLOY_RED)
    ...
    private static final TinkerMaterial BOOMERITE = new TinkerMaterial(Ids.BOOMERITE, Materials.INGOT_CAST_BOOMERITE.asOne(), "#d94c00")
        .setLiquidTexture(SkullTextures.ALLOY_PURPLE)
    ...
    private static final TinkerMaterial SEFIRITE = new TinkerMaterial(Ids.SEFIRITE, Materials.INGOT_CAST_SEFIRITE.asOne(), "#9beb34")
        .setLiquidTexture(SkullTextures.ALLOY_GREEN)
    ...
    private static final TinkerMaterial LIQUID_CHRISTMAS = new TinkerMaterial(Ids.LIQUID_CHRISTMAS, SlimefunItems.CHRISTMAS_PRESENT.asOne(), "#00cc36")
        .setLiquidTexture(SkullTextures.ALLOY_GREEN)
        .setFormIngot(SlimefunItems.CHRISTMAS_PRESENT.getItemId())
        .build();

    private static final TinkerMaterial CRINGLEIUM = new TinkerMaterial(Ids.CRINGLEIUM, Materials.INGOT_CAST_CRINGLEIUM.asOne(), "#00cc36")
        .setLiquidTexture(SkullTextures.ALLOY_GREEN)
    ...
    private static final TinkerMaterial FLOWING_FONDNESS = new TinkerMaterial(Ids.FLOWING_FONDNESS, SlimefunItems.RAINBOW_GLASS_VALENTINE.asOne(), "#eb34d2")
        .setLiquidTexture(SkullTextures.ALLOY_PINK)
    ...
    private static final TinkerMaterial DETAILED_DEVOTION = new TinkerMaterial(Ids.DETAILED_DEVOTION, SlimefunItems.RAINBOW_CONCRETE_VALENTINE.asOne(), "#e68cd9")
        .setLiquidTexture(SkullTextures.ALLOY_PINK)
    ...
    private static final TinkerMaterial PURIFIED_PASSION = new TinkerMaterial(Ids.PURIFIED_PASSION, SlimefunItems.RAINBOW_GLAZED_TERRACOTTA_VALENTINE.asOne(), "#471240")
        .setLiquidTexture(SkullTextures.ALLOY_PINK)
    ...
    private static final TinkerMaterial LIQUID_LOVE = new TinkerMaterial(Ids.LIQUID_LOVE, Materials.INGOT_CAST_LOVE.asOne(), "#eb34d2")
        .setLiquidTexture(SkullTextures.ALLOY_PINK)
    ...
    private static final TinkerMaterial NICEINIUM = new TinkerMaterial(Ids.NICEINIUM, Materials.INGOT_CAST_NICE.asOne(), "#80550d")
        .setLiquidTexture(SkullTextures.ALLOY_TAN)
    ...
    private static final TinkerMaterial SMITHIUM = new TinkerMaterial(Ids.SMITHIUM, Materials.INGOT_CAST_SMITHIUM.asOne(), "#6E7F80")
        .setLiquidTexture(SkullTextures.ALLOY_SILVER)
    ...
    private static final TinkerMaterial ANNIVERSARIUM = new TinkerMaterial(Ids.ANNIVERSARIUM, Materials.INGOT_CAST_ANNIVERSARIUM.asOne(), "#32b41e")
        .setLiquidTexture(SkullTextures.ALLOY_RED)
