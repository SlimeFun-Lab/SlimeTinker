...
public final class Workstations {
    ...
    private static final ItemStack[] RECIPE_TINKERS_SMELTERY_MULTI = new ItemStack[]{
        Materials.SEARED_BRICK_BLOCK.asOne(), Materials.SEARED_BRICK_BLOCK.asOne(), Materials.SEARED_BRICK_BLOCK.asOne(),
        Materials.SEARED_TANK.asOne(), Materials.SMELTERY_CONTROLLER.asOne(), Materials.SPOUT.asOne(),
        Materials.SEARED_BRICK_BLOCK.asOne(), Materials.SEARED_BRICK_BLOCK.asOne(), Materials.SEARED_BRICK_BLOCK.asOne()
    };
    ...
    private static final ItemStack[] RECIPE_TINKERS_TABLE = new ItemStack[]{
        Materials.BLOCK_CAST_STEEL.asOne(), Materials.BLOCK_CAST_STEEL.asOne(), Materials.BLOCK_CAST_STEEL.asOne(),
        new ItemStack(Material.OAK_PLANKS), Workstations.TINKERS_WORKBENCH.asOne(), new ItemStack(Material.OAK_PLANKS),
        new ItemStack(Material.OAK_PLANKS), SlimefunItems.POWER_CRYSTAL.asOne(), new ItemStack(Material.OAK_PLANKS)
    };

    private static final ItemStack[] RECIPE_TINKERS_ARMOUR_TABLE = new ItemStack[]{
        Materials.BLOCK_CAST_DAMASCUS_STEEL.asOne(), Materials.BLOCK_CAST_DAMASCUS_STEEL.asOne(), Materials.BLOCK_CAST_DAMASCUS_STEEL.asOne(),
        new ItemStack(Material.OAK_PLANKS), Workstations.TINKERS_WORKBENCH.asOne(), new ItemStack(Material.OAK_PLANKS),
        new ItemStack(Material.OAK_PLANKS), SlimefunItems.POWER_CRYSTAL.asOne(), new ItemStack(Material.OAK_PLANKS)
    };

    private static final ItemStack[] RECIPE_TINKERS_REPAIR_BENCH = new ItemStack[]{
        Materials.BLOCK_CAST_ALUMINUM.asOne(), Materials.BLOCK_CAST_ALUMINUM.asOne(), Materials.BLOCK_CAST_ALUMINUM.asOne(),
        new ItemStack(Material.OAK_PLANKS), Workstations.TINKERS_WORKBENCH.asOne(), new ItemStack(Material.OAK_PLANKS),
        new ItemStack(Material.OAK_PLANKS), SlimefunItems.POWER_CRYSTAL.asOne(), new ItemStack(Material.OAK_PLANKS)
    };

    private static final ItemStack[] RECIPE_TINKERS_SWAPPING_STATION = new ItemStack[]{
        Materials.BLOCK_CAST_COR_BRONZE.asOne(), Materials.BLOCK_CAST_COR_BRONZE.asOne(), Materials.BLOCK_CAST_COR_BRONZE.asOne(),
        new ItemStack(Material.OAK_PLANKS), Workstations.TINKERS_WORKBENCH.asOne(), new ItemStack(Material.OAK_PLANKS),
        new ItemStack(Material.OAK_PLANKS), SlimefunItems.POWER_CRYSTAL.asOne(), new ItemStack(Material.OAK_PLANKS)
    };
    ...
    private static final ItemStack[] RECIPE_TINKERS_MOD_STATION = new ItemStack[]{
        ...
        new ItemStack(Material.OAK_PLANKS), Workstations.TINKERS_TABLE.asOne(), new ItemStack(Material.OAK_PLANKS),
        new ItemStack(Material.OAK_PLANKS), SlimefunItems.POWER_CRYSTAL.asOne(), new ItemStack(Material.OAK_PLANKS)
    };
